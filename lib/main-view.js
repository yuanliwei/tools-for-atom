    ...
    var html = `
        <div class="container pt-5">
          <div class="row">
            ...
            <hr>
            <div class="col-12">
              <input type="file" class="zipinput btn btn-lg btn-primary" accept="application/zip" name="app.zip"/>
              <button type="button" class="alert btn btn-primary" name="button">UserLog</button>
