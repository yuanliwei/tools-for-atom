...
export default class WorkHoursView extends BaseView{
  ...
  initialize(){
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="input-group col-12 mt-2">
            ...
            <atom-text-editor class="inputEditor form-control" mini=true placeholderText='Find in current buffer'></atom-text-editor>
          </div>
    ...
    WorkHoursView_loadData((progress, resp)=>{
      ...
      var editor = view.find('.inputEditor')[0].getModel()
