...
export default class UserLogView {
        ...
        <div class="container pt-5">
          <div class="row">
            ...
            <div class="logbuttons col-12">
              <button type="button" class="fileList btn btn-lg btn-primary">用户日志文件列表</button>
              <button type="button" class="userInfo btn btn-lg btn-primary">用户信息</button>
            </div>
          </div>
        </div>
      `
  ...
  addUploadQueueButton(userDb){
    const {dom, zip} = this
    var btn = $(`<button type="button" class="btn btn-lg btn-primary">上传队列</button>`)
